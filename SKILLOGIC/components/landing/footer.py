    ...
    return rx.box(
        rx.flex(
            rx.flex(
                ...
                rx.link(t("Construido con Reflex", "Built with Reflex"), href="https://reflex.dev", is_external=True, font_size=T.TEXT_SM, color_scheme="gray", color=T.TEXT_MUTED, opacity="0.6", text_decoration="none", _hover={"opacity": "1", "color": T.BRAND_LIGHT}, transition=f"all {T.EASE_BASE}"),
                gap="2",
                align="center",
                flex_wrap="wrap",
                justify="center",
