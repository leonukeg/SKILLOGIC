    ...
    return rx.box(
        rx.flex(
            rx.flex(
                ...
                rx.link(t("Construido con Reflex", "Built with Reflex"), id="my-footer-link", href="https://reflex.dev", is_external=True, font_size=T.TEXT_SM, class_name="footer-link"),
                gap="2",
                align="center",
                flex_wrap="wrap",
                justify="center",
            ...
            rx.flex(
                rx.link(t("Términos", "Terms"), href="/terms", font_size=T.TEXT_SM, class_name="footer-link"),
                rx.link(t("Privacidad", "Privacy"), href="/privacy", font_size=T.TEXT_SM, class_name="footer-link"),
                rx.link(t("Cookies", "Cookies"), href="/cookies", font_size=T.TEXT_SM, class_name="footer-link"),
                gap=T.SPACE_4,
                flex_wrap="wrap",
                justify="center",
            ),
